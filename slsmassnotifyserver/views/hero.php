...
<div class="well" style="padding: 16px; overflow: hidden; margin-bottom: 20px;">
	<div class="row" style="margin: 0; display: flex; align-items: center; flex-wrap: wrap;">
		<div class="col-md-3" style="padding: 0 15px 0 0;">
			<img src="<?php echo htmlspecialchars($hero_image); ?>" alt="<?php echo _('Southland Servers Mass Notification Plugin'); ?>" style="width: 100%; max-width: 240px; height: auto; display: block;">
		</div>
