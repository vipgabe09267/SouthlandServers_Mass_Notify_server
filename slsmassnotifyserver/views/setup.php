	...
	<div class="row">
		<div class="col-sm-12">
			...
			<?php } ?>
				...
				<div class="row">
					<div class="col-md-2"><div class="form-group"><label><?php echo _('Location'); ?></label><input class="form-control" name="xweather[location]" value="<?php echo htmlspecialchars($xweather['location'] ?? ''); ?>" placeholder="Round Rock, TX or 30.5083,-97.6789"></div></div>
					...
					<div class="col-md-3"><div class="form-group"><label><?php echo _('Strike type'); ?></label><select class="form-control" name="xweather[strike_type]"><option value="cloud_to_ground" <?php echo ($xweather['strike_type']??'cloud_to_ground')==='cloud_to_ground'?'selected':''; ?>><?php echo _('Cloud to ground'); ?></option><option value="cloud_to_cloud" <?php echo ($xweather['strike_type']??'')==='cloud_to_cloud'?'selected':''; ?>><?php echo _('Cloud to cloud'); ?></option><option value="both" <?php echo ($xweather['strike_type']??'')==='both'?'selected':''; ?>><?php echo _('Both'); ?></option></select></div></div>
