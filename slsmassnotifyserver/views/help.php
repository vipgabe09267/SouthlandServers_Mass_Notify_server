...
<div class="container-fluid">
	...
	<ul>
		...
		<li><?php echo _('Version 0.1.4-beta fixes installation with older Asterisk-owned log files, checks Python before opening protected logs, and secures temporary installer and uninstall diagnostics. Existing settings, phone payloads, and paging behavior are preserved.'); ?></li>
