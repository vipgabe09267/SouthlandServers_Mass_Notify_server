...
CURRENT_VERSION="${SLS_MASS_NOTIFY_CURRENT_VERSION:-0.1.3-beta}"
...
current = os.environ.get("CURRENT_VERSION", "0.1.3-beta")
...
try:
    request = urllib.request.Request(
        ...
        headers={"Accept": "application/vnd.github+json", "User-Agent": "SouthlandServers-Mass-Notifications-Updater/0.1.3-beta"},
    )
